INSERT INTO `rent_ap`.`authority` (`id_authority`, `authority`) VALUES (1, 'role_admin');
INSERT INTO `rent_ap`.`authority` (`id_authority`, `authority`) VALUES (2, 'role_user');
INSERT INTO `rent_ap`.`authority` (`id_authority`, `authority`) VALUES (3, 'role_anonymous');

INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (1, 'Заводской');
INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (2, 'Ленинский');
INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (3, 'Московский');
INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (4, 'Октябрьский');
INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (5, 'Партизанский');
INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (6, 'Первомайский');
INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (7, 'Советский');
INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (8, 'Фрунзенский');
INSERT INTO `rent_ap`.`area` (`id_area`, `name`) VALUES (9, 'Центральный');

INSERT INTO `rent_ap`.`status` (`id_status`, `type`) VALUES (1, 'на рынке');
INSERT INTO `rent_ap`.`status` (`id_status`, `type`) VALUES (2, 'в обрарботке');
INSERT INTO `rent_ap`.`status` (`id_status`, `type`) VALUES (3, 'арендована');
INSERT INTO `rent_ap`.`status` (`id_status`, `type`) VALUES (4, 'продана');

INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (1, 'Пушкинская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (2, 'Борисовский тракт');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (3, 'Восток');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (4, 'Московская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (5, 'Парк Челюскинцев');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (6, 'Академия наук');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (7, 'Площадь Якуба Коласа');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (8, 'Площадь Победы');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (9, 'Октябрьская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (10, 'Институт Культуры');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (11, 'Грушевка');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (12, 'Михалово');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (13, 'Петровщина');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (14, 'Малиновка');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (15, 'Каменная Горка');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (16, 'Кунцевщина');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (17, 'Спортивная');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (18, 'Молодёжная');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (19, 'Фрунзенская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (20, 'Немига');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (21, 'Купаловская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (22, 'Первомайская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (23, 'Пролетарская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (24, 'Тракторный завод');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (25, 'Партизанская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (26, 'Автозаводская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (27, 'Могилёвская');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (28, 'Уручье');
INSERT INTO `rent_ap`.`subway`(`id_subway`, `name`) VALUES (29, 'Площадь Ленина');

INSERT INTO `rent_ap`.`user` (`id_user`, `enabled`, `name`, `password`, `surname`, `username`)
...
INSERT INTO `rent_ap`.`user_authority` VALUES (1, 1);
INSERT INTO `rent_ap`.`user_authority` VALUES (2, 2);
INSERT INTO `rent_ap`.`user_authority` VALUES (3, 2);

INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('1', '2', '5', '250', '2017-11-26', '1', '2');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('2', '3', '4', '300', '2017-12-02', '1', '1');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('3', '4', '4', '350', '2017-11-26', '1', '2');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('4', '2', '5', '300', '2017-11-26', '1', '2');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('5', '2', '4.6', '350', '2017-12-09', '1', '3');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('6', '4', '3.5', '400', '2017-12-09', '1', '3');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('7', '3', '2.4', '300', '2017-12-09', '1', '3');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('8', '5', '4.9', '600', '2017-12-09', '1', '3');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('9', '4', '5.0', '700', '2017-12-09', '1', '3');
INSERT INTO `rent_ap`.`flat` (`id_flat`, `amount_room`, `average_mark`, `month_price`, `upload_date`, `id_status`, `id_user`)
VALUES ('10', '2', '4.1', '350', '2017-12-09', '1', '2');


INSERT INTO `rent_ap`.`address` (`id_address`, `flat_number`, `house_number`, `street`, `id_area`, `id_flat`)
...
INSERT INTO `rent_ap`.`subway_address` (`id_address`, `id_subway`) VALUES ('2', '1');

INSERT INTO `rent_ap`.`image` (`id_image`, `url`, `id_flat`)
